...
- `syntheses/2026-05-24-23-22-05-团体辅导方案写作规范.md`: Claim `每项活动应包含名称、目的、时间、规则四要素` is missing structured evidence.
- `syntheses/2026-05-24-23-22-05-团体辅导方案写作规范.md`: Claim `效果评估应包含前测和后测量表对比` is missing structured evidence.
- `syntheses/2026-05-24-23-22-05-团体辅导方案写作规范.md`: Claim `常用测量工具包括自我效能量表、人际交往能力问卷、情绪智力量表等` is missing structured evidence.
- `syntheses/2026-05-24-23-22-13-团体心理辅导.md`: Claim `《团体心理辅导》由樊富珉、何瑾编著，华东师范大学出版社出版` is missing structured evidence.
- `syntheses/2026-05-24-23-22-13-团体心理辅导.md`: Claim `团体发展经历初期阶段、转换阶段、工作阶段、结束阶段四个时期` is missing structured evidence.
- `syntheses/2026-05-24-23-22-13-团体心理辅导.md`: Claim `团体辅导场所需满足舒适性、功能性、保密性、互动性、非干扰性五个要求` is missing structured evidence.
- `syntheses/2026-05-24-23-22-13-团体心理辅导.md`: Claim `团体辅导目标分为成长性、训练性、治疗性三类` is missing structured evidence.
- `syntheses/2026-05-24-23-22-13-团体心理辅导.md`: Claim `团体辅导常用技术包括倾听、复述、反映、澄清、提问、总结等` is missing structured evidence.
