...
| 分类 | 说明 | 数量 |
|------|------|------|
| [实体 (Entities)](#entities) | Agent 个人页面、系统实体 | 5 |
| [概念 (Concepts)](#concepts) | 规范、标准、模板 | 7 |
| [综合 (Syntheses)](#syntheses) | 任务看板、案例、模板 | 3 |
| [报告 (Reports)](#reports) | 诊断、统计、目录 | 10 |
| [来源 (Sources)](#sources) | 记忆桥接、仓库配置 | 228 |
...
| [教研室仓库](sources/teaching-repository.md) | 教研室仓库结构 |
| [教学助手课程表](sources/teaching-course-schedule.md) | 课程安排 |
| [教务助手课程安排](sources/academic-course-schedule.md) | 课程安排 |

### Agent 记忆桥接

> Memory Bridge 文件按 Agent 和 dreaming 类型自动归档，共 228 个文件。
> 详见下方自动生成索引。
...
### Syntheses
- [[syntheses/2026-05-17-18-40-33-Agent-Memory-设计哲学与架构|Agent Memory 设计哲学与架构]]
- [[syntheses/2026-05-17-18-40-33-agent-memory|Agent Memory（智能体记忆系统）]]
- [[syntheses/2026-05-19-18-25-37-agents|Agent 行为规范模板（AGENTS.md）]]
- [[syntheses/2026-05-19-18-25-37-bootstrap|BOOTSTRAP Agent初始化模板]]
- [[syntheses/2026-05-19-18-25-37-heartbeat|HEARTBEAT 心跳任务模板]]
- [[syntheses/2026-05-19-18-25-37-identity|IDENTITY 身份模板（IDENTITY.md）]]
- [[syntheses/2026-05-19-18-25-37-if-then-rule-standard|If-Then 规则修改标准]]
- [[syntheses/2026-05-21-10-42-53-memory|MEMORY 记忆模板（MEMORY.md）]]
- [[syntheses/2026-05-19-18-25-37-soul|SOUL 人格模板（SOUL.md）]]
- [[syntheses/2026-05-19-18-25-37-tools|TOOLS 工具配置模板（TOOLS.md）]]
- [[syntheses/2026-05-19-18-25-37-user|USER 用户画像模板（USER.md）]]
- [[syntheses/2026-05-20-23-34-38-三方协作实践-代理领取任务与执行流程|三方协作实践：代理领取任务与执行流程]]
...
- [[syntheses/2026-05-20-23-47-31-教育科学研究方法-多代理协作总结|教育科学研究方法-多代理协作总结]]
- [[syntheses/2026-05-19-22-53-22-program-project|程序项目]]
...
- [[syntheses/2026-05-19-18-25-37-thesis-project|论文项目]]
- [[syntheses/2026-05-19-18-25-37-course-project|课程项目]]
