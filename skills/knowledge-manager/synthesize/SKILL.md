...
| 检查参考文献 | 使用[reference_checker.py](./reference_checker.py) |
...
| `研究现状模板.md` | 研究现状模板文件 |
| `reference_checker.py` | 参考文献检查与修复类（面向对象） |
...
#### 步骤 6：保存文档
- 草稿：`~/实验室仓库/项目文件/{项目名}/草稿/{标题}/{标题}：{类型}_v{version}.md`
- 终稿：`~/实验室仓库/项目文件/{项目名}/知识库/综述/{标题}：{类型}.md`
