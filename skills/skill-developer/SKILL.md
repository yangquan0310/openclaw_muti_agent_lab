...
description: >
  当用户要求「创建一个新技能」「开发一个新技能」「更新技能」「维护技能」「教我开发技能」「检查技能质量」「规范技能命名」「修复技能错误」「遵循技能设计原则」「界定技能边界」「管理技能版本」「理解技能加载机制」时触发。
  用于指导代理创建、扩展、检查、修复、重构可复用的 OpenClaw 技能，涵盖技能创建、扩展、质量标准、设计原则、边界约束、常见错误、命名规范、版本管理、渐进式披露。
version: 5.2.0
author: Yang Quan
metadata:
  openclaw:
