...
本文件夹用于存储数学家的**个人技能**，每个技能是一个独立的程序模块或文档规范，可被主代理直接调用或委派给子代理执行。
...
| 技能名称 | 触发示例 | 描述 | 路径 |
|---------|---------|------|------|
| agent_self_development | `自我更新`、`每日维护` | Agent 自我发展框架，包含工作记忆管理、技能更新、配置维护等功能 | `skills/agent_self_development/`（软链接） |
