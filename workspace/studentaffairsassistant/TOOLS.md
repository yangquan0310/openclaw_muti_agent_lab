...
| 脚本名称 | 触发示例 | 描述 | 路径 |
|----------|----------|----------|------|
| 学生信息管理 | 收到学生信息、查询学生档案 | 学生信息分类、存储、元数据记录 | ~/.openclaw/workspace/studentaffairsassistant/scripts/学生信息管理/SKILL.md |
| 学业辅导 | 记录学业问题、协调辅导资源 | 学业问题识别、辅导记录、资源协调 | ~/.openclaw/workspace/studentaffairsassistant/scripts/学业辅导/SKILL.md |
| 社团活动记录 | 组织社团活动、记录活动过程 | 活动记录、资料管理、档案保存 | ~/.openclaw/workspace/studentaffairsassistant/scripts/社团活动记录/SKILL.md |

---

*最后重构: 2026-04-13 18:42 (每日索引更新)*
*重构者: 学工助手*