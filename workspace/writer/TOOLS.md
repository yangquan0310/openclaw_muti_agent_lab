...
| Agent 临时文件 | `~/.openclaw/workspace/writer/temp/README.md` | 临时文件存储目录 |
| Agent 工作记忆 | `~/.openclaw/workspace/writer/memory/` | OpenClaw 核心记忆系统 |
...
| 技能名称 | 触发示例 | 描述 | 路径 |
|---------|---------|------|------|
| writer | 写、写作、撰写、论文、文章、报告、文档、方案、修改、润色 | 通用写作技能：覆盖一切写作任务（学术论文、综述、报告、方案、文档等） | `skills/writer/SKILL.md` |
