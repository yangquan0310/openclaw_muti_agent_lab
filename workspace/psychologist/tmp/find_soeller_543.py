...
# Memory & Cognition volume 49 issue 3 2021 page 543
query = "issn:0090-502X volume:49 issue:3 year:2021"
encoded_query = urllib.parse.quote(query)
url = f"https://api.crossref.org/works?query={encoded_query}&rows=40"

req = urllib.request.Request(url)
with urllib.request.urlopen(req) as response:
    data = json.load(response)
    print(f"Scanning Volume 49 Issue 3 2021...")
    print()
