...
|----------|--------|--------|----------|----------|----------|----------|----------|
| 每日 04:00 | 心理学家（psychologist） | `f1a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c` | 每日维护任务 | 1)维护TOOLS.md：维护个人技能索引、维护个人脚本索引<br>2)维护MEMORY.md：维护任务看板、维护活跃子代理清单<br>3)工作空间维护：删除多余文件、维护临时文件夹、维护脚本文件夹 | `~/.openclaw/workspace/psychologist/skills/每日维护/SKILL.md` | 子代理执行 | enabled |
