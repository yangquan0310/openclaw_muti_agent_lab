...
|----------|--------|--------|----------|----------|----------|
| 每日 04:00 | 心理学家（psychologist） | `978b0800-5035-4784-9645-c40f700c623d` | 每日维护任务 | 1)维护TOOLS.md - 维护个人技能索引、个人脚本索引、维护项目表<br>2)维护MEMORY.md - 维护任务看板、维护活跃子代理清单、维护程序性记忆脚本位置表<br>3)工作空间维护 - 核查配置文件缺失、维护临时文件夹、维护技能文件夹、维护脚本文件夹、删除多余文件 | enabled |
