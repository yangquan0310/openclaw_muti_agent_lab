...
bash ~/.openclaw/workspace/psychologist/scripts/维护工作记忆.sh 2>&1 | tee -a "$LOG_FILE"
...
# 定义应该存在的文件和文件夹
EXPECTED_ITEMS=("AGENTS.md" "HEARTBEAT.md" "IDENTITY.md" "MEMORY.md" "SOUL.md" "TOOLS.md" "USER.md" "memory" "scripts" "temp")
