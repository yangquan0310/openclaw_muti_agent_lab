...
| Agent 临时文件 | `~/.openclaw/workspace/psychologist/temp/README.md` | 临时文件存储目录 |
| Agent 工作记忆 | `~/.openclaw/workspace/psychologist/memory/` | OpenClaw 核心记忆系统 |
...
> 完整列表见: `~/.openclaw/workspace/psychologist/skills/README.md`
