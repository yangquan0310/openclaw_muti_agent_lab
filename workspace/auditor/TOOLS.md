...
| 文件 | 存储路径 | 说明 |
|------|----------|------|
| Agent 个人记忆 | `~/.openclaw/workspace/auditor/MEMORY.md` | 督导独立维护 |
| Agent 个人技能 | `~/.openclaw/workspace/auditor/skills/README.md` | 技能存储目录说明 |
| Agent 临时文件 | `~/.openclaw/workspace/auditor/temp/README.md` | 临时文件存储目录说明 |
| Agent 工作记忆 | `~/.openclaw/workspace/auditor/memory/` | OpenClaw 核心记忆系统 |
...
> 完整列表见: `~/.openclaw/workspace/auditor/skills/README.md`
