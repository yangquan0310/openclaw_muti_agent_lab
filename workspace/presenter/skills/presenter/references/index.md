...
| 指南 | 说明 |
|------|------|
| [PPT 制作指南](ppt-guide.md) | 脚本格式 → Layout 选择 → 编译命令 |
| [脚本编写指南](script-writing-guide.md) | 完整脚本编写规范（含示例和格式速查） |
| [Layout 选择指南](layout-choice-guide.md) | 4 种路径查找合适的 Layout |
...
**制作 PPT**
1. [PPT 制作指南](ppt-guide.md)
2. [脚本编写指南](script-writing-guide.md)
3. [Layout 选择指南](layout-choice-guide.md)
4. [Slide 设计指南](slide-design-guide.md)
5. [质量检查清单](quality-standards.md)
