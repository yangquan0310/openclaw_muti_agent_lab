...
FORMULA_TABLE: Dict[str, Dict] = {
    ...
    # ===== 脏腑·补肾阴（地黄丸家族） =====
    "F-补-015":   {"name": "杞菊地黄丸", "classic_formula": "杞菊地黄丸", "category": "脏腑·补肾阴",
                   "indications": "肝肾阴虚：头晕目眩、视物模糊、眼睛干涩、迎风流泪、耳鸣",
                   "dosage": "浓缩丸一次8丸，一日3次；大蜜丸一次1丸，一日2次",
                   "caution": "脾虚便溏者慎用；感冒发热停用",
                   "source": "《医级》杞菊地黄丸（六味+枸杞菊花）"},
    "F-补-016":   {"name": "麦味地黄丸", "classic_formula": "麦味地黄丸", "category": "脏腑·补肾阴",
                   "indications": "肺肾阴虚：干咳少痰、咽干咳喘、潮热盗汗、腰膝酸软",
                   "dosage": "浓缩丸一次8丸，一日3次；大蜜丸一次1丸，一日2次",
                   "caution": "脾虚便溏、痰湿壅盛者慎用；感冒发热停用",
                   "source": "《寿世保元》麦味地黄丸（六味+麦冬五味子）"},
    "F-补-017":   {"name": "归芍地黄丸", "classic_formula": "归芍地黄丸", "category": "脏腑·补肾阴",
                   "indications": "肝肾两亏、阴虚血少：头晕目眩、耳鸣咽干、午后潮热、月经量少",
                   "dosage": "大蜜丸一次1丸，一日2-3次；水蜜丸一次6g，一日2-3次",
                   "caution": "脾虚便溏者慎用；感冒发热停用",
                   "source": "《中国药典》归芍地黄丸（六味+当归白芍）"},
    "F-补-018":   {"name": "明目地黄丸", "classic_formula": "明目地黄丸", "category": "脏腑·补肾阴",
                   "indications": "肝肾阴虚目疾：目涩畏光、视物模糊、迎风流泪、久视眼干",
                   "dosage": "大蜜丸一次1丸，一日2次；水蜜丸一次6g，一日2次",
                   "caution": "暴发火眼（急性结膜炎）不宜；脾虚便溏者慎用",
                   "source": "《审视瑶函》明目地黄丸（六味+枸杞菊花当归白芍蒺藜石决明）"},

    # ===== 脏腑·补肾阳（地黄丸家族） =====
    "F-补-019":   {"name": "桂附地黄丸", "classic_formula": "桂附地黄丸", "category": "脏腑·补肾阳",
                   "indications": "肾阳不足：腰膝酸冷、肢体浮肿、小便不利或反多、畏寒肢冷",
                   "dosage": "大蜜丸一次1丸，一日2次；水蜜丸一次6g，一日2次",
                   "caution": "阴虚火旺、实热者不宜；孕妇慎用；含附子忌过量久服",
                   "source": "《医宗金鉴》桂附地黄丸（六味+肉桂附子）"},
    "F-补-020":   {"name": "右归丸", "classic_formula": "右归丸", "category": "脏腑·补肾阳",
                   "indications": "肾阳不足、命门火衰：畏寒肢冷、腰膝软弱、阳痿遗精、便溏尿频",
                   "dosage": "大蜜丸一次1丸，一日3次；水蜜丸一次9g，一日3次",
                   "caution": "阴虚火旺者忌用；孕妇慎用；感冒发热停用",
                   "source": "《景岳全书》右归丸（六味去三泻+桂附鹿角胶等）"},
    "F-补-021":   {"name": "济生肾气丸", "classic_formula": "济生肾气丸", "category": "脏腑·补肾阳",
                   "indications": "肾阳不足、水湿内停：水肿、小便不利、腰膝酸重、痰饮喘咳",
                   "dosage": "大蜜丸一次1丸，一日2次；水蜜丸一次6g，一日2-3次",
                   "caution": "阴虚火旺者不宜；孕妇慎用；含附子忌过量久服",
                   "source": "《济生方》济生肾气丸（金匮肾气丸+牛膝车前子）"},
