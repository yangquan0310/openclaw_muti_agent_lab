...
| **流通**（Layer 1）| `bazi-liutong.md` | v2.1.0 | 子平 / 滴天 |
...
| **流通体系** | [`references/bazi-liutong.md`](references/bazi-liutong.md) v2.1.0 |
