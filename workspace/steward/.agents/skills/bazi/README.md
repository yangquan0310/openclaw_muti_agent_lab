...
| 9 | **体用融合** | 4 大治法——调候 / 抑扶 / 通关 / 对症 |
| 10 | **大运 + 八字反查** | 顺/逆排大运 + 60 甲子反查 |
...
│ ├── bazi-tiyong.md v1.3.3 [体用] = 融合产物——4 大治法总览：调候/抑扶/通关/对症
...
│ ├── bazi-paipan.md v3.1.0 [分析总纲] 四线导航 + 分析流程 + 宫星系统
...
| **体用**——Layer 2| `bazi-tiyong.md` | v1.3.3 | 渊海 / 子平 / 滴天 / 穷通 |

> **关键**：体用是**融合产物**——基于正格 + 旺衰，**不是第四种分析**。
...
| **排盘技术规范** | [`references/bazi-paipan.md`](references/bazi-paipan.md) v3.1.0 |
...
| **神煞体系**（仅工具查询，不进入分析）| [`references/bazi-shensha.md`](references/bazi-shensha.md) v2.2.0 |
| **体用体系** | [`references/bazi-tiyong.md`](references/bazi-tiyong.md) v1.3.3 |
...
| **输出风格（含一段话范式）** | [`references/bazi-style.md`](references/bazi-style.md) v3.19.0 |
...
| v1.7.0 | 2026-08-08 | 三层模型框架 + bazi-tiyong.md 新建 + bazi-paipan 重命名 |
...
| v1.13.0 | 2026-08-13 | SKILL.md 整合——流通独立标记 + 体用完全移入|
| v2.0.0 | 2026-07-26 | 大六壬排盘——天地盘/四课/三传 4 宗门|
| **v2.2.0** | **2026-08-15** | **🆕 神煞 28 → 34——合并传统派补充：福星/天厨/德秀/披麻/飞刃/退神；修正文昌多值版+太极版本 B** |
| **v2.2.0** | **2026-08-15** | **🆕 README 重写**：修正版本号漂移 + 删除已合并的 `bazi-shiju.md` 引用 + 更新为当前版本——旺衰 v2.1.0 / 神煞 v2.2.0 / 体用 v1.3.3 / 正格 v1.0.1 / 排盘 v2.2.0 |
