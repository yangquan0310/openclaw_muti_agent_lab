...
| 每日 08:00 | 大管家（steward） | `2cd2fbc1-8357-471a-a030-5b33a3f8d6fc` | 老板八字运势日报 | 每日早 8:00 给老板推送八字运势日报：排盘 + 9-23 时流时速览 + 五维运势（事业/人际/姻缘/健康/性格）+ 餐饮推荐（午晚餐）+ 具体行动表；流派「基于格局分析的传统命理现代化」；announce → **当前 QQ bot 单聊**（2026-08-01 改：老板拍板从飞书私聊迁移到当前 QQ bot 会话 `chat_id=qqbot:c2c:9F3209C188797074357241443CF8176F`） | `{"enabled": "已启用"}` |
...
*最后更新: 2026-08-01*
*更新者: 大管家*
*说明: T043 渠道迁移：飞书私聊 → 当前 QQ bot 单聊（老板拍板）*