...
|----------|--------|--------|----------|----------|----------|----------|----------|
| 每日 04:00 | 大管家（steward） | `ab40d36a-e823-4404-8411-cc9446414562` | 每日维护任务 | 1)维护TOOLS.md：维护个人技能索引、维护个人脚本索引<br>2)维护MEMORY.md：维护任务看板、维护活跃子代理清单<br>3)工作空间维护：删除多余文件、维护临时文件夹、维护脚本文件夹 | `~/.openclaw/workspace/steward/skills/每日维护/SKILL.md` | 子代理执行 | enabled |
