...
|----------|--------|--------|----------|----------|----------|----------|----------|
| 每日 04:00 | 大管家（steward） | `ab40d36a-e823-4404-8411-cc9446414562` | 每日维护任务 | 1)更新TOOLS.md：个人技能索引、个人脚本索引<br>2)更新MEMORY.md：任务看板、活跃子代理清单<br>3)工作空间维护：检查多余文件、维护临时文件夹、维护脚本文件夹 | `~/.openclaw/workspace/steward/scripts/` | 子代理执行 | enabled |
