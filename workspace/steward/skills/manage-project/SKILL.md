...
|------|------|
| `SKILL.md` | 本技能说明文档 |
| `maintain/maintain.py` | 核心Python类，支持命令行和导入调用 |
...
### Step 1: 初始化项目对象
```python
from maintain.maintain import Project
...
```bash
# 整理单个项目
python3 maintain/maintain.py /path/to/project

# 整理所有项目
python3 maintain/maintain.py --all

# 预览模式（不实际执行）
python3 maintain/maintain.py /path/to/project --dry-run
```
