...
![OpenClaw](https://img.shields.io/badge/OpenClaw-v3.2.5-blue.svg)
...
### 版本 3.2.6 (2026-05-03)
- **安全审计**：扫描并确认无硬编码 API Key，所有密钥均使用系统变量引用
- **README更新**：同步版本号、时间戳、运行状态（2026-05-03 05:46 CST）
